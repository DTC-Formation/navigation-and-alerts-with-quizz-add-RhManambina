...
import 'package:projet/question_model.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 226, 220, 224),
      body: Container(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
              color: Color.fromARGB(255, 37, 131, 71),
